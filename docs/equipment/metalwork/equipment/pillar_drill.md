...
Pillar drill in the metal workshop – safety and tips
...
To use the drill, you will need to pass a short online quiz. Read the information here, then take the quiz here and follow the instructions to get access to the drill.
...
Workholding: Never hold the workpiece with your hands. Use the supplied drill vices, toggle clamps or G-clamps to secure your metal to the table. The vices must be bolted down.
...
Depth stop: To set a depth stop, loosen the bolt, slide the ring around to your desired depth, and tighten the bolt back. Our drill is quite old, so this is marked in inches.
Speed (RPM)
